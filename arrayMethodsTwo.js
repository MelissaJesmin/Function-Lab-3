...
// CODE HERE
numbers.forEach(div => console.log(div/2))
...
// CODE HERE
let city = cities.filter(c => c.charAt(c.length-1) === "i")
console.log(city)
...
/* 
    ...
    if it's an apple or orange by its color. 
    ...
    If the color is not red or apple, print "The fruit with index [THE ELEMENT'S INDEX] 
...
fruits.forEach((element,index) => {
  ...
  else if (element.color !== "red" || element.color !== "orange") {
